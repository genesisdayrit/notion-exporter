...
# Define a subdirectory for files without extensions or suspected binaries
unknown_dir = os.path.join(other_dir, "binaries_or_unknown")
...
for entry in entries:
    ...
    if ext:
        ...
        # Move files without an extension or suspected binaries to the 'binaries_or_unknown' directory
        shutil.move(full_path, os.path.join(unknown_dir, entry))

print("Files have been successfully organized into the 'other' directory. Stray files without extensions have been moved to 'binaries_or_unknown'.")
